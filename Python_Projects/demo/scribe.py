...
class Canvas:
    ...
    #Update the element or set the character 'mark' in pos[0,1]
    ...
    def print(self):                                #print the current state of canvas at the terminal
        self.clear()
...
# Take in canvas class (At what it is supposed to draw on)
